...
from HarleyRobot.modules import ALL_MODULES
from HarleyRobot.modules.helper_funcs.chat_status import is_user_admin
from HarleyRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/HarleyQuinn_RoBot?startgroup=true"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("HarleyRobot.modules." + module_name)
...
def harley_about_callback(update, context):
    ...
    if query.data == "harley_":
        query.message.edit_text(
            text=""" ℹ️ ɪ'ᴍ *ʜᴀʀʟᴇʏ ϙᴜɪɴɴ*, ᴀ ᴘᴏᴡᴇʀғᴜʟ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴜɪʟᴛ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴇᴀsɪʟʏ.         
...
\n\n_Harley's licensed under the GNU General Public License v3.0_
\n❍ 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 @SSJ4GOGETA          
\n❍ 𝐒𝐮𝐩𝐩𝐨𝐫𝐭 𝐆𝐫𝐨𝐮𝐩 @HarleyQuinnSupport            
\n❍ 𝐔𝐩𝐝𝐚𝐭𝐞 & 𝐍𝐞𝐰𝐬 @HarleyQuinnNews.            
\n𝑯𝒆𝒓𝒆 𝒊𝒔 𝒎𝒚 [𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞](https://github.com/gogeta0sama/HarleyRobot).
\nɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ϙᴜᴇsᴛɪᴏɴ ᴀʙᴏᴜᴛ ʜᴀʀʟᴇʏ ϙᴜɪɴɴ, ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="harley_back")
                 ]
                ]
            ),
        )
    elif query.data == "harley_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Harley Quinn*
                 \nHere is the [Source Code](https://github.com/gogeta0sama/HarleyRobot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝑰'𝒎 𝑯𝒂𝒓𝒍𝒆𝒚 𝑭𝒓𝒆𝒂𝒌𝒊𝒏' 𝑸𝒖𝒊𝒏𝒏! ☠")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(harley_about_callback, pattern=r"harley_")
